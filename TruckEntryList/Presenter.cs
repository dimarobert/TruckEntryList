...
namespace TruckEntryList {
    public partial class Presenter : Form {
        ...
        private void UpdateDisplay() {
            ...
            lstTruckOrder.Size = new Size(lstTruckOrder.Width, (int)(availableArea.Height * 0.8));

            lstSkip.Location = new Point(availableArea.Width - lstTruckOrder.Size.Width, (int)(availableArea.Height * 0.8) + 3);
            lstSkip.Size = new Size(lstTruckOrder.Width, (int)(availableArea.Height * 0.2) - 5);
        ...
        private void UpdateSkip() {
            ...
            for (int i = 0; i < parent.SkipData.Count; i++) {
                AddToSkipList(parent.SkipData[i]);
            }
        }
